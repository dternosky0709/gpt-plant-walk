...
assert.match(app, /const APP_VERSION = "1\.3\.1";/);
...
assert.match(worker, /gpt-plant-walk-1\.3\.1/);
...
console.log("PASS: GPT Plant Walk 1.3.1 gallery navigation, work-order details, packet repair, and offline cache.");
