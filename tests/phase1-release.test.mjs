...
assert.match(app, /const APP_VERSION = "1\.2\.1";/);
...
assert.match(worker, /gpt-plant-walk-1\.2\.1/);
...
console.log("PASS: GPT Plant Walk 1.2.1 AI history summary and offline cache.");
