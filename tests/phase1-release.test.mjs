...
assert.match(app, /const APP_VERSION = "1\.2\.0";/);
...
assert.match(worker, /gpt-plant-walk-1\.2\.0/);
...
console.log("PASS: GPT Plant Walk 1.2.0 industrial navigation and offline cache.");
