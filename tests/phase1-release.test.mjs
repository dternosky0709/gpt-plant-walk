...
assert.match(index, /<h1>GPT Plant Walk 1\.1<\/h1>/);
...
assert.match(app, /const APP_VERSION = "1\.1";/);
...
assert.match(worker, /gpt-plant-walk-1\.1/);
...
console.log("PASS: GPT Plant Walk 1.1 simplified release flow and offline cache.");
