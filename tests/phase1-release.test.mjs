...
assert.match(index, /<h1>GPT Plant Walk 1\.1\.2<\/h1>/);
...
assert.match(app, /const APP_VERSION = "1\.1\.2";/);
...
assert.match(worker, /gpt-plant-walk-1\.1\.2/);
...
console.log("PASS: GPT Plant Walk 1.1.2 simplified release flow and offline cache.");
