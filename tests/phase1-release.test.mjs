...
assert.match(app, /const APP_VERSION = "1\.3\.2";/);
...
assert.match(worker, /gpt-plant-walk-1\.3\.2/);
...
console.log("PASS: GPT Plant Walk 1.3.2 gallery navigation, work-order details, Planner cutover, packet repair, and offline cache.");
